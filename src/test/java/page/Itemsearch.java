...
public class Itemsearch {
	  ...
	  WebDriver driver;
	   @FindBy(xpath="//*[@id=\"shopify-section-sections--16911351152888__header\"]/header/div[1]/div/div/div/nav/predictive-search/form/button")
	   ...
	   { 
		   ...
		   y.executeScript("window.scrollBy(0,400)");
	   }
	}
